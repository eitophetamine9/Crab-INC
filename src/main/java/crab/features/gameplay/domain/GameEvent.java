...
public record GameEvent(String name, String targetPlayerId, int goldDelta, int wealthDelta, int reputationDelta, int infamyDelta) implements java.io.Serializable {
